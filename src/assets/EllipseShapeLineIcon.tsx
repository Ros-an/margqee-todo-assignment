...
function EllipseShapeLineIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
...
const MemoEllipseShapeLineIcon = React.memo(EllipseShapeLineIcon);
export default MemoEllipseShapeLineIcon;
