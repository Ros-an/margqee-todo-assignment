...
function RecycleBinIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 109.484 122.88" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
const MemoRecycleBinIcon = React.memo(RecycleBinIcon);
export default MemoRecycleBinIcon;
